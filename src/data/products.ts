...
export const products: Product[] = [
  {
    ...
    description: 'Latest flagship smartphone with advanced AI features and premium design.',
  },
  {
    id: '2',
  ...
  },
  {
    ...
    image: laptop1,
    category: 'Laptops',
    description: 'Professional laptop with M3 chip, perfect for creative work and development.',
  },
  {
    id: '4',
  ...
  },
  {
    ...
    image: phone1,
    category: 'Smartphones',
    description: 'Next-generation smartphone with enhanced camera and performance.',
  },
  {
    id: '6',
    name: 'StudioMax Pro',
...
export const categories = ['All', 'Smartphones', 'Audio', 'Laptops', 'Wearables'];
